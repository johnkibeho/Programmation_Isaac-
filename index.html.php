...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">HEAL CLINIC</a></h1>
  ...
  <section id="home" class="d-flex align-items-center">
    <div class="container">
      <h1>Welcome to heal clinic<br> Healthcare</h1>
...
<br><br><br><br><br><br><br><br>
  ...
  <footer id="footer">
    ...
    <div class="container">
      ...
      <div class="credits">
        Designed by <a href="https://gripsan-raiyani.firebaseapp.com/" target="_blank">Gripsan Raiyani</a>
      </div>
    </div>
  </footer><!-- End Footer -->
